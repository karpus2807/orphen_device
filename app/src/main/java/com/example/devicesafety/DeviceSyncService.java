...
public class DeviceSyncService extends Service {
    public static final String ACTION_REQUEST_DEVICE_ADMIN = "com.example.devicesafety.REQUEST_DEVICE_ADMIN";
    public static final String ACTION_SYNC_UPDATE = "com.example.devicesafety.SYNC_UPDATE";
