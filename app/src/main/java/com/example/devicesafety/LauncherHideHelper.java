...
final class LauncherHideHelper {
    ...
    private static final String LAUNCHER_MAIN_CLASS = "com.example.devicesafety.LauncherAlias";
    private static final String LAUNCHER_CAMO_CLASS = "com.example.devicesafety.LauncherCamo";
